...
namespace BluePrismTechChallenge
{
    public record SearchOptions()
    {
        ...
        [Option('d', "dictionary", Required = true, HelpText = "File path name of the file with the list of words.")]
        public string WordsDictionaryFilePath { get; init; }
        [Option('r', "result", Required = true, HelpText = "File pathname of file where the results will be writen.")]
